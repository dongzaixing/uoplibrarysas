...
/*
	...
	*/
	...
	$.ajax({
		...
		var su_Text = "STUDENT-UNION";
		var ds_text = "WILLIAM-BEATTY-BUIDLING";
		var sc_text = "SPINNAKER-SPORT-CENTER";
		loadText(su_Text,-7900,500,-1000,"UPSU");
		loadText(ds_text,-2852,500,-5486,"DENTAL-ACADEMY");
		loadText(sc_text,-4501,600,6062,"SPORT-CENTER");
...
var render = function () {
	...
	var aCText5 = app.scene.getObjectByName("SPORT-CENTER");
	...
	var aCText5_area = app.scene.getObjectByName("SPORT-CENTER-area");
	...
	var aCText5_intro = app.scene.getObjectByName("SPORT-CENTER-intro");
